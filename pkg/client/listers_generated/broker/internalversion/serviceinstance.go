...
type ServiceInstanceLister interface {
	...
	List(selector labels.Selector) (ret []*broker.ServiceInstance, err error)
...
// List lists all ServiceInstances in the indexer.
func (s *serviceInstanceLister) List(selector labels.Selector) (ret []*broker.ServiceInstance, err error) {
	err = cache.ListAll(s.indexer, selector, func(m interface{}) {
		ret = append(ret, m.(*broker.ServiceInstance))
	})
	return ret, err
}
...
type ServiceInstanceNamespaceLister interface {
	...
	Get(name string) (*broker.ServiceInstance, error)
...
// List lists all ServiceInstances in the indexer for a given namespace.
func (s serviceInstanceNamespaceLister) List(selector labels.Selector) (ret []*broker.ServiceInstance, err error) {
...
// Get retrieves the ServiceInstance from the indexer for a given namespace and name.
func (s serviceInstanceNamespaceLister) Get(name string) (*broker.ServiceInstance, error) {
	...
	return obj.(*broker.ServiceInstance), nil
}
