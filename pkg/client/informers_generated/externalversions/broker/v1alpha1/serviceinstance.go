	...
	sharedIndexInformer := cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				return client.BrokerV1alpha1().ServiceInstances(v1.NamespaceAll).List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				return client.BrokerV1alpha1().ServiceInstances(v1.NamespaceAll).Watch(options)
			},
		},
		&broker_v1alpha1.ServiceInstance{},
		resyncPeriod,
...
func (f *serviceInstanceInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&broker_v1alpha1.ServiceInstance{}, newServiceInstanceInformer)
}
