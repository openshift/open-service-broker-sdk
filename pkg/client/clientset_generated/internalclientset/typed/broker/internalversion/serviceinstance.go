...
import (
	...
	scheme "github.com/openshift/open-service-broker-sdk/pkg/client/clientset_generated/internalclientset/scheme"
...
type ServiceInstanceInterface interface {
	Create(*broker.ServiceInstance) (*broker.ServiceInstance, error)
	Update(*broker.ServiceInstance) (*broker.ServiceInstance, error)
	UpdateStatus(*broker.ServiceInstance) (*broker.ServiceInstance, error)
	Delete(name string, options *v1.DeleteOptions) error
	DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error
	Get(name string, options v1.GetOptions) (*broker.ServiceInstance, error)
	List(opts v1.ListOptions) (*broker.ServiceInstanceList, error)
	Watch(opts v1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *broker.ServiceInstance, err error)
...
func newServiceInstances(c *BrokerClient, namespace string) *serviceInstances {
...
func (c *serviceInstances) Create(serviceInstance *broker.ServiceInstance) (result *broker.ServiceInstance, err error) {
	result = &broker.ServiceInstance{}
	err = c.client.Post().
		Namespace(c.ns).
...
func (c *serviceInstances) Update(serviceInstance *broker.ServiceInstance) (result *broker.ServiceInstance, err error) {
	result = &broker.ServiceInstance{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("serviceinstances").
...
func (c *serviceInstances) UpdateStatus(serviceInstance *broker.ServiceInstance) (result *broker.ServiceInstance, err error) {
	result = &broker.ServiceInstance{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("serviceinstances").
...
func (c *serviceInstances) Get(name string, options v1.GetOptions) (result *broker.ServiceInstance, err error) {
	result = &broker.ServiceInstance{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("serviceinstances").
...
func (c *serviceInstances) List(opts v1.ListOptions) (result *broker.ServiceInstanceList, err error) {
	result = &broker.ServiceInstanceList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("serviceinstances").
...
func (c *serviceInstances) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *broker.ServiceInstance, err error) {
	result = &broker.ServiceInstance{}
