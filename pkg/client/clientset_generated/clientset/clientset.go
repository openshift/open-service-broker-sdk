...
type Interface interface {
	...
	Broker() brokerv1alpha1.BrokerV1alpha1Interface
}
...
type Clientset struct {
	...
	*brokerv1alpha1.BrokerV1alpha1Client
}
...
func (c *Clientset) BrokerV1alpha1() brokerv1alpha1.BrokerV1alpha1Interface {
	...
	return c.BrokerV1alpha1Client
}

// Deprecated: Broker retrieves the default version of BrokerClient.
// Please explicitly pick a version.
func (c *Clientset) Broker() brokerv1alpha1.BrokerV1alpha1Interface {
	if c == nil {
		return nil
	}
	return c.BrokerV1alpha1Client
...
func NewForConfig(c *rest.Config) (*Clientset, error) {
	...
	var cs Clientset
	var err error
	cs.BrokerV1alpha1Client, err = brokerv1alpha1.NewForConfig(&configShallowCopy)
	if err != nil {
		return nil, err
	}
...
func NewForConfigOrDie(c *rest.Config) *Clientset {
	var cs Clientset
	cs.BrokerV1alpha1Client = brokerv1alpha1.NewForConfigOrDie(c)
...
func New(c rest.Interface) *Clientset {
	var cs Clientset
	cs.BrokerV1alpha1Client = brokerv1alpha1.New(c)
