...
${BINDIR}/informer-gen "$@" \
	      ...
	      --input-dirs "github.com/openshift/open-service-broker-sdk/pkg/apis/broker" \
	      --input-dirs "github.com/openshift/open-service-broker-sdk/pkg/apis/broker/v1alpha1" \
	      --internal-clientset-package "github.com/openshift/open-service-broker-sdk/pkg/client/clientset_generated/internalclientset" \
	      --versioned-clientset-package "github.com/openshift/open-service-broker-sdk/pkg/client/clientset_generated/clientset" \
	      --listers-package "github.com/openshift/open-service-broker-sdk/pkg/client/listers_generated" \
	      --output-package "github.com/openshift/open-service-broker-sdk/pkg/client/informers_generated"
